...
export default function LandingPage() {
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-background">
      {/* ── Navbar ── */}
      <header className="absolute inset-x-0 top-0 z-20 h-16 border-b border-border/20 bg-background/20 backdrop-blur-md">
        ...
        <nav className="hidden md:flex items-center gap-6">
          {[
            ...
            { label: "Export", href: "/editor" },
            { label: "Preview", href: "/editor" },
          ].map(({ label, href }) => (
            <a
              key={label}
              href={href}
